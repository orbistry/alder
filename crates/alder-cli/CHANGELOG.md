...
- [95f5d9b](https://github.com/orbistry/alder/commit/95f5d9bef285ae46f884bace7cf97fabd54d8d91) Keep the production build identity stable across prerendering and final bundling,
  preventing unnecessary navigation reloads and loss of browser state. — Thanks @rvcas!
- Updated dependencies: alder-bundle@0.5.0, alder-codegen@0.6.0, alder-driver@0.8.0, alder-fmt@0.4.0, alder-language-server@0.2.3, alder-runtime@0.4.0
